#!/bin/bash
# 
# Installer for PyLops GPU environment with Cupy and CUDA 11.8
# 
# Run: ./install_pylops_cupy_3090.sh pylops_dir
# 
# M. Ravasi, 26/08/2021
...
conda env create -f environment_pylops_cupy_3090.yml
source ~/miniconda3/etc/profile.d/conda.sh
conda activate pylops_cupy_3090
